...
* Betweenness: Indicates information flow (Design)
* In-Degree of Creativity Network: Perceived Creativity (Design)
* Eigenvector Centrality: Indicates influence (Lobbying)
* In-Degree of Influence Network: Perceived Influence (Lobbying)
* Closeness: Indicates cohesiveness (Implementation)
* In-Degree of Implementation Network: Perceived Execution Skills (Implementation)
